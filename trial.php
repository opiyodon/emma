    ...
    if ($res == TRUE) {
        ...
        if ($count > 0) {
            ...
            while ($rows = mysqli_fetch_assoc($res)) {
                ...
                <section id="sidebar" class="sidebar ||| sidebarOpen">
                    ...
                    <div id="aboutContainer" class="about">
                        <div class="about-card">
                            ...
                            <p class="about-txt">
                                E.M.M.A encapsulates the qualities of being someone to confide in,
                                providing personal and relatable conversations, while also
                                emphasizing its AI capabilities as an emotional companion.
                            </p>
                        </div>
                        <div class="about-card">
                        ...
                        if ($count > 0) {
                            ...
                            while ($rows = mysqli_fetch_assoc($res)) {
                                ...
                                <section id="chat-wrapper" class="chat-wrapper">
                                    ...
                                    <?php include 'loadChatHistory.php'; ?>
                                    ...
                                    <div class="delete">
                                        <div class="message-chatbot">
                                            ...
                                            <!-- more options -->
                                            <form action="" method="post" class="more-options-box">
                                                ...
                                                <div class="more-options-modal ||| ">
                                                    <button name="more-options-delete-btn" type="submit" class="more-options-btn red"
                                                        value="<?php echo $rows['id']; ?>">Delete</button>
                                                    <button id="more-options-copy-btn" class="more-options-btn">Copy</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                ...
                <?php
                // Process the value from the form and delete the message from the database
                if (isset($_POST['more-options-delete-btn'])) {
                    $chat_id = $_POST['more-options-delete-btn'];
                    $sql_delete_chat = "DELETE FROM chat_history WHERE id = $chat_id";

                    // Execute the delete query
                    if (mysqli_query($conn, $sql_delete_chat)) {
                        // Message deleted successfully
                        $_SESSION['deleteMessage'] = "<div class='successContainer'>
        <div class='SUCCESSBOX'>
            <div class='SUCCESS2'>Message Deleted Successfully</div>
        </div>
    </div>";
                        // Redirect to index page or wherever appropriate
                        header('location:' . SITEURL_USER . 'index.php');
                        ...
                        $_SESSION['deleteMessage'] = "<div class='errorContainer'>
        <div class='ERRORBOX'>
            <div class='ERROR2'>Failed to Delete Message</div>
        </div>
    </div>";
                        // Redirect to index page or wherever appropriate
                        header('location:' . SITEURL_USER . 'index.php');
